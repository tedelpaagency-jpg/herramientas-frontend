        ...
        <table class="main-container" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td style="padding: 0 24px 32px 24px;">
                    <h2 style="margin: 0 0 12px 0; font-size: 22px; font-weight: 800; color: #1e293b; letter-spacing: -0.025em;">Credenciales de Acceso</h2>
                    ...
                    <table width="100%" style="background-color: #f8fafc; border-radius: 12px; border: 1px solid #e2e8f0; overflow: hidden;">
                        <tr>
                            <td style="padding: 20px; border-left: 4px solid #1877f2;">
                                <div style="font-size: 12px; text-transform: uppercase; color: #64748b; font-weight: 700; letter-spacing: 0.05em; margin-bottom: 6px;">Usuario</div>
                                <div style="font-size: 18px; color: #0f172a; font-weight: 700; margin-bottom: 16px;"><?= $username; ?></div>
                                
                            </td>
                            <td style="padding: 20px; border-left: 4px solid #1877f2;">
                                <div style="font-size: 12px; text-transform: uppercase; color: #64748b; font-weight: 700; letter-spacing: 0.05em; margin-bottom: 6px;">Contraseña</div>
                                <div style="font-size: 18px; color: #0f172a; font-weight: 700; margin-bottom: 16px;"><?= $password; ?></div>

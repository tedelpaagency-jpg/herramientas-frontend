                        ...
                        <div class="col-xl-12">
                            <div class="card shadow-xss w-100 d-block d-flex border-0 p-4 mb-3">
                                <div class="card-body d-flex align-items-center p-0">
                                    ...
                                    <h2 class="fw-700 mb-0 mt-0 font-md text-grey-900">Ruletas</h2>
                                    ...
                                    <a href="javascript:void(0)" onclick="showAjaxModal('<?= base_url(); ?>modal/popup/roulette_form')" data-toggle="modal" class="btn-round-md ms-2 bg-success theme-dark-bg rounded-3 text-white"><i class="feather-plus-circle font-xss "></i></a>
                                </div>
                            </div>
                                       ...
                                       <table class="table " id="sale_data">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $rewards = $this->db->get('roulettes')->result_array();
                                                    foreach($rewards as $row):
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <!-- Botón Copiar -->
                                                                <!-- Botón Editar -->
                                                                <a href="<?= base_url('portal/roulette_rewards/'.base64_encode($row['id'])) ?>"
                                                                ...
                                                                <a href="javascript:void(0)"
                                                                   ...
                                                                   title="Editar"
                                                                   onclick="showAjaxModal('<?= base_url('modal/popup/roulette_form/'.$row['id']) ?>')">
                                                                ...
                                                                <a href="javascript:void(0)"
                                                                   ...
                                                                   title="Eliminar"
                                                                   onclick="delete_item('portal/roulettes/deleteRoulette/<?= base64_encode($row['id']); ?>')">

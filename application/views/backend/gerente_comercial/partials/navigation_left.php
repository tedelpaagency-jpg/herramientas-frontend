                ...
                <div class="nav-content">
                    <div class="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2">
                        ...
                        <ul class="mb-1 top-content">
                            ...
                            <li><a href="<?= base_url(); ?>portal/agencies" class="nav-content-bttn open-font" ><i class="feather-award btn-round-md bg-red-gradiant me-3"></i><span>Agencias</span></a></li>
                    ...
                    <div class="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2">
                        ...
                        <ul class="mb-3">
                            ...
                            <li><a href="<?= base_url(); ?>portal/courses" class="nav-content-bttn open-font"><i class="font-xl text-current feather-box me-3"></i><span>Cursos</span><span class="circle-count bg-warning mt-1">0</span></a></li>

                                       ...
                                       <table class="table text-nowrap" id="dataTable">
                                            <thead>
                                                <tr class="fw-700 font-xssss text-grey-900 pt-3 pb-3 ">
                                                    ...
                                                    <th class="border-0 py-2">Agente</th>
                                                    <th class="border-0 py-2">Gerente</th>
                                                    <th class="border-0 py-2">Director</th>
                                                    <th class="border-0 py-2">Empresa</th>
                                                ...
                                                <?php 
                                                  ...
                                                  <tr>
                                                    <td>
                                                        ...
                                                        <td>
                                                             <?php if($sale->total_commissionable == ''): ?><span class="badge border border-warning text-warning bg-transparent">Pendiente</span><?php else: ?><span class="badge border border-success text-success bg-transparent">$<?php $total_sale = $sale->total_additional+$sale->total_fee; echo number_format($total_sale,2,'.',',');?></span><?php endif; ?>
                                                        </td>
                                                        <td>
                                                             <?php if($sale->total_commissionable == ''): ?><span class="badge border border-warning text-warning bg-transparent">Pendiente</span><?php else: ?><span class="badge border border-success text-success bg-transparent">$<?= number_format($sale->total_commissionable,2,'.',','); ?></span><?php endif; ?>
                                                        </td>
                                                        <td>
                                                            <?php if($sale->total_commissionable == ''): ?><span class="badge border border-warning text-warning bg-transparent">Pendiente</span><?php else: ?><span class="badge border border-success text-success bg-transparent">$<?php $gerente = ($sale->total_commissionable * $sale->commition_percent_gerente)/100; echo number_format($gerente,2,'.',','); ?></span><?php endif; ?>
                                                        </td>
                                                        
                                                        <td>
                                                             <?php if($sale->total_commissionable == ''): ?><span class="badge border border-warning text-warning bg-transparent">Pendiente</span><?php else: ?><span class="badge border border-success text-success bg-transparent">$<?php $director = ($sale->total_commissionable* $sale->commition_percent_director)/100; echo number_format($director,2,'.',','); ?></span><?php endif; ?>
                                                        </td>
                                                        <td>
                                                            <?php if($sale->total_commissionable == ''): ?><span class="badge border border-warning text-warning bg-transparent">Pendiente</span><?php else: ?><span class="badge border border-success text-success bg-transparent">$<?php $total_sale2 = $total_sale -($sale->total_commissionable + $gerente + $director); echo  number_format($total_sale2,2,'.',','); ?></span><?php endif; ?>
                                                        </td>
                                                        ...
                                                        <td >
                                                            ...
                                                            <?php if($sale->status == 2): ?>
                                                                <a  class="badge border border-danger text-danger bg-transparent" onclick="delete_element('portal/detailssale/delete/<?= base64_encode($sale->sale_id); ?>')"><i class="fa-solid fa-trash"></i></a>
                                                            <?php else: ?>
                                                                <a  class="badge border border-danger text-danger bg-transparent" onclick="delete_element('portal/detailssale/reject/<?= base64_encode($sale->sale_id); ?>')"><i class="fa-solid fa-x"></i></a>
                                                            
                                                            <?php endif; ?>
                                                            <?php else:?>
                                                                <?php if($sale->status == 0): ?>
                                                                     <a  class="badge border border-danger text-danger bg-transparent" onclick="preaprove_element('portal/detailssale/preauth_sale/<?= base64_encode($sale->sale_id); ?>')"><i class='fa-solid fa-check'></i></a>
                                                                     <a  class="badge border border-danger text-danger bg-transparent" onclick="delete_element('portal/detailssale/reject/<?= base64_encode($sale->sale_id); ?>')"><i class="fa-solid fa-trash"></i></a>
                                                                <?php endif?>

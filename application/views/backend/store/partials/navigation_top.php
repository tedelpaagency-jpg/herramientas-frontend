<div class="nav-header bg-white shadow-xs border-0">
            ...
            <div class="ms-auto">
                <center>
                    ...
                    <a href="default-video.html" class="p-2 text-center ms-0 menu-icon center-menu-icon"><i class="feather-video font-lg  btn-round-lg theme-dark-bg <?= ($page_name == 'videos') ? 'alert-primary text-current' : 'bg-greylight text-grey-500'; ?> "></i></a>
                    <a href="<?= base_url(); ?>portal/users/<?= base64_encode(2); ?>" class="p-2 text-center ms-0 menu-icon center-menu-icon"><i class="<?= ($page_name == 'users') ? 'feather-user font-lg alert-primary btn-round-lg theme-dark-bg text-current' : 'feather-user font-lg bg-greylight btn-round-lg theme-dark-bg text-grey-500 '; ?> "></i></a>

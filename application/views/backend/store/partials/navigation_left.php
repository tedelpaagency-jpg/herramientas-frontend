<?php $form = $this->db->get_where('forms',['user_id'=>$this->session->userdata('login_user_id')])->row_array(); ?>
            ...
            <div class="container ps-0 pe-0">
                <div class="nav-content">
                    ...
                    <div class="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2">
                        ...
                        <ul class="mb-3">
                            <li><a href="<?= base_url(); ?>portal/requests/<?php echo base64_encode($form['forms_id']);?>" class="nav-content-bttn open-font"><i class="font-xl text-current feather-file-text me-3"></i><span>Leaps</span></a></li>
                        </ul>
                    </div>

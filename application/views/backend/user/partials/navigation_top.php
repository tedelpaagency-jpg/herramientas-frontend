<div class="nav-header bg-white shadow-xs border-0">
            <div class="nav-top">
                <a href="<?= base_url(); ?>portal/feed" class="logo-container">
                    <img src='<?= base_url(); ?>public/assets/images/logo/<?= $this->crud_model->getInfo('logo');?>' class="logo-img">
                </a>
            ...
            <div class="ms-auto">
                <center>
                    ...
                    <a href="<?= base_url(); ?>portal/pos" class="p-2 text-center ms-0 menu-icon center-menu-icon"><i class="feather-shopping-bag font-lg  btn-round-lg theme-dark-bg <?= ($page_name == 'pos') ? 'alert-primary text-current' : 'bg-greylight text-grey-500'; ?> "></i></a>
                     ...
                     <a href="https://ziigo.pro" target="_blank" class="p-2 text-center ms-0 menu-icon center-menu-icon"><i class="feather-send font-lg  btn-round-lg theme-dark-bg bg-greylight text-grey-500 "></i></a>
                    
                    <?php $academy = $this->crud_model->getAcademy(); ?>
                    <?php if($academy != ''): ?>
                    <a href="$academy" target="_blank" href="<?= base_url(); ?>portal/pos" class="p-2 text-center ms-0 menu-icon center-menu-icon"><i class="feather-book font-lg  btn-round-lg theme-dark-bg bg-greylight text-grey-500 "></i></a>
                    <?php endif; ?>
            ...
            <a href="#" class="p-2 text-center ms-3 menu-icon chat-active-btn" style="visibility:hidden" ><i class="feather-message-square font-xl text-current"></i></a>

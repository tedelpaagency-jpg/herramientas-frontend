<div class="app-footer border-0 shadow-lg bg-primary-gradiant">
    ...
    <a href="<?= base_url(); ?>portal/travel_sales/<?= base64_encode(2); ?>" class="nav-content-bttn" data-tab="chats"><i class="feather-briefcase"></i></a>            
    <a href="<?= base_url(); ?>portal/tasks" class="nav-content-bttn"><i class="feather-zap"></i></a>

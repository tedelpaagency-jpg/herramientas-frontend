...
<?php 
if(isset($param2))
    $row = $this->db->get_where('roulettes', ['id' => $param2])->row();
?>
...
<form method="post" action="<?php echo base_url('portal/roulettes/saveRoulette/'.base64_encode($row->id)); ?>">
    ...
    <div class="modal-body row">
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control" name="title"
                value="<?php echo isset($row) ? $row->title : ''; ?>">
        </div>

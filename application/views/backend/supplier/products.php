            ...
            <div class="col-xl-12">
                <div class="card shadow-xss w-100 d-block d-flex border-0 p-4 mb-3">
                    <div class="card-body d-flex align-items-center p-0">
                        ...
                        <a href="<?= base_url(); ?>portal/add_edit_product/"  data-toggle="modal" class="btn-round-md ms-2 bg-success theme-dark-bg rounded-3 text-white"><i class="feather-plus-circle font-xss "></i></a>
                    </div>
                </div>
                <div class="card shadow-xss w-100 d-block d-flex border-0 p-4 mb-3">
                    <div class="card-body d-flex align-items-center p-0">
                      ...
                      <div class="filters row mb-3" style="z-index: 1010 !important; " id="sticky1">
                            <form action="<?= base_url('portal/products'); ?>" method="GET" class="row" />
                                  <div class="col-md-3">
                ...
                <div class="row ps-2 pe-1">
                    ...
                    <div class="card-body">
                              ...
                              <?php 
                                    ...
                                    <tr>
                                      ...
                                      <img src="<?php if (strpos($main_image, 'public') !== false): ?>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url(); ?>portal/detailproduct/<?php echo base64_encode($product['id']); ?>"
                                                                       class="badge border border-success text-success bg-transparent copyLink"
                                                                       title="Copiar enlace" >
                                                                        <i class="fa-solid fa-file-lines  fa-fw"></i>
                                                                    </a>
                                             <!-- Botón Editar -->
                                            <a href="<?php echo base_url(); ?>portal/add_edit_product/<?php echo base64_encode($product['id']); ?>"
                                            ...
                                            <!-- Botón Eliminar -->
                                            <a href="javascript:void(0)" onclick="delete_element('portal/add_edit_product/delete/<?php echo base64_encode($product['id']); ?>')" 
                        ...
                        <?php
                            ...
                            $base_url = base_url('portal/products');
                            ?>
                            <div class="dataTables_paginate paging_simple_numbers">
                                <a class="paginate_button previous <?= ($current_page == 1) ? 'disabled' : '' ?>"
                                   href="<?= $base_url . '?page=' . ($current_page - 1) . ($query_string ? '&' . $query_string : '') ?>">Anterior</a>
                                ...
                                <a class="paginate_button next <?= ($current_page == $total_pages) ? 'disabled' : '' ?>"
                                   href="<?= $base_url . '?page=' . ($current_page + 1) . ($query_string ? '&' . $query_string : '') ?>">Sigueinte</a>
                            </div>

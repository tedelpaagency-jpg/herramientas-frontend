                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if($sale['status'] == 0 ):?>
                                                                    <a href="javascript:void(0);" onclick="reject_element('portal/travel_report_details/reject/<?= base64_encode($sale['sale_id']); ?>')" class="btn btn-danger text-white">Rechazar</a>
                                                                    <a href="javascript:void(0);" onclick="auth_element('portal/travel_report_details/auth/<?= base64_encode($sale['sale_id']); ?>')" class="btn btn-success text-white">Aprobar</a>
                                                                ...
                                                                <?php elseif($sale['status'] == 4):?>
                                                                    <a href="javascript:void(0);" onclick="reject_element('portal/travel_report_details/reject/<?= base64_encode($sale['sale_id']); ?>')" class="btn btn-danger">Rechazar</a>
                                                                    <a href="javascript:void(0);" onclick="auth_element('portal/travel_report_details/auth/<?= base64_encode($sale['sale_id']); ?>')" class="btn btn-success">Venta aprobada</a>

...
<div class="modal-body p-0">
    <div class="card w-100 border-0 rounded-3 overflow-hidden bg-gradiant-bottom bg-gradiant-top" style="height: 650px;">
        <div class="">
                ...
                <div class="item">
                    ...
                    <?php if ($is_video): ?>
                        <video class=""
                               autoplay
                               loop
                               playsinline style="border-radius: 20px;width: 100%;">

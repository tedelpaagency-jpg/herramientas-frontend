...
<div class="modal-body row">
        ...
        <div class="col-md-6">
            ...
            <input class="form-control" id="validationCustom01" placeholder="" required="" value="" name="gerent_commition_percent" type="text" />
           
        </div>
        <div class="col-md-6">
            <label class="mont-font fw-600 font-xsss" for="validationCustom01">Comision de agencia</label>
            <input class="form-control" id="validationCustom01" placeholder="" required="" value="" name="commition_percent" type="text" />
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-12 mt-2">
            <div class="form-group ">
                <label for="email" class="mont-font fw-600 font-xsss">País</label>
                <select id="pais" class="form-control mb-3" name="pais_id" required="">
        ...
        <div class="col-12">
             <div class="mb-3">
                 ...
                 <select class="form-select select2" name="gerente_id"  style="width:100%">
                     ...
                     <option value="<?= $user->user_id; ?>" ><?= $user->name.' '.$user->last_name.'('.$user->phone.')'; ?></option>
                     <?php endforeach; ?>
                 </select>
             </div>
        </div>
        <div class="col-md-12">
            ...
            <select class="form-control select2" name="suppliers[]" multiple="">

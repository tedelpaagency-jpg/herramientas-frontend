                            ...
                            <div class="card shadow-xss w-100 d-block d-flex border-0 p-4 mb-3">
                                <div class="card-body d-flex align-items-center p-0">
                                    ...
                                    <a href="#" class="btn-round-md ms-2 bg-greylight theme-dark-bg rounded-3"><i class="feather-filter font-xss text-grey-500"></i></a>
                                      <a href="<?= base_url(); ?>portal/add_edit_product/0/1" class="btn-round-md ms-2 bg-success theme-dark-bg rounded-3 text-white"><i class="feather-plus-circle font-xss "></i></a>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 mb-3 pe-2 ps-2">
                                    <div class="card w-100 p-0 hover-card shadow-xss border-0 rounded-3 overflow-hidden me-1">
                                        <div class="card-image w-100 mb-3">
                                            <a href="<?= base_url(); ?>portal/product_details/<?= base64_encode($product['id']); ?>" class="position-relative d-block"><img src="<?= $src; ?>" alt="image" class="w-100" style="    height: 250px;" onerror="this.onerror=null; this.src='<?= base_url(); ?>public/assets/images/logo/<?= $this->crud_model->getInfo('logo');?>';"></a>
                                        </div>
                                        <div class="card-body pt-0">
                                            ...
                                            <h4 class="fw-700 font-xss mt-0 lh-28 mb-0"><a href="<?= base_url(); ?>portal/product_details/<?= base64_encode($product['id']); ?>" class="text-dark text-grey-900"><?php echo $product['name']; ?></a></h4>

                ...
                <div class="col-xl-12">
                    <div class="card shadow-xss w-100 d-block d-flex border-0 p-4 mb-3">
                        <div class="card-body d-flex align-items-center p-0">
                            <h2 class="fw-700 mb-0 mt-0 font-md text-grey-900">Balance</h2>
                            ...
                            <a href="javascript:void(0)" onclick="showAjaxModal('<?= base_url(); ?>modal/popup/comissions_form')" class="btn-round-md ms-2 bg-success theme-dark-bg rounded-3 text-white"><i class="feather-plus-circle font-xss "></i></a>
                        </div>
                    </div>

                    <div class="card  shadow-xss rounded-xxl border-0 mb-3 mt-3">
                        <div class="card-body d-flex align-items-center  p-4">
                            <h4 class="fw-700 mb-0 font-xssss text-grey-900">Listado de comisiones</h4>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive table-centered" style="padding:50px;">
                                        <table class="display table table-striped text-nowrap" id="example">
                                            ...
                                            <tbody>
                                                <?php $finanzas = $this->db->order_by('id','DESC')->get_where('commission',[])->result(); ?>
                                                <?php foreach($finanzas as $finanza): ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $finanza->type == 1 ? '<span class="badge border border-success text-success bg-transparent">Ingreso</span>':'<span class="badge text-light-danger">Retiro</span>'; ?></td>
                                                        <td>
                                                            <?php echo $finanza->status == 0 ? '<span class="badge border border-warning text-warning bg-transparent">Pendiente</span>':''; ?>
                                                            <?php echo $finanza->status == 1 ? '<span class="badge border border-success text-success bg-transparent">Aprovado</span>':''; ?>
                                                            <?php echo $finanza->status == 2 ? '<span class="badge border border-danger text-danger bg-transparent">Rechazado</span>':''; ?>
                                                        </td>

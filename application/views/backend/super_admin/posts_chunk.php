        ...
        <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
            <div class="card-body p-0 d-flex">
                ...
                <div class="dropdown-menu dropdown-menu-end p-4 rounded-xxl border-0 shadow-lg" aria-labelledby="dropdownMenu2">
                    <div class="card-body p-0 d-flex">
                        <a class="d-flex" href="javascript:void(0)" onclick="delete_item('portal/feed/delete_post/<?= base64_encode($notice['id']); ?>')">
                            <i class="feather-trash text-danger me-3 font-lg"></i>
                            <h4 class="fw-600 text-danger font-xssss mt-0 me-4">Eliminar <span class="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500">post</span></h4>
                        </a>
                    </div>
                </div>
            </div>

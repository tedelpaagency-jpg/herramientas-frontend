                        ...
                        <div class="col-xl-12  chat-left scroll-bar">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 mb-3 pe-2 ps-2">
                                    <div class="card w-100 p-0 hover-card shadow-xss border-0 rounded-3 overflow-hidden me-1">
                                        ...
                                        <div class="card-body pt-0">
                                          ...
                                          <?php endif;?>
                                          <a href="<?php echo base_url(); ?>portal/add_edit_product/delete/<?= base64_encode($product['id']); ?>" 
                                               class="bottom-15 mb-2 right-15"
                                               onclick="return confirm('¿Estás seguro de eliminar este producto?');">
                                               <i class="btn-round-sm bg-danger text-white font-sm feather-x"></i>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card  shadow-xss rounded-xxl border-0 mb-3 mt-3">
                                <div class="card-body d-flex align-items-center  p-4">
                                    <h4 class="fw-700 mb-0 font-xssss text-grey-900">Listado de adelantos</h4>
                                </div>
                                            ...
                                            <tbody>
                                                 <?php 
                                                   ...
                                                   <tr>
                                                       ...
                                                       <td>
                                                           <a href="<?= base_url(); ?>portal/product_visa_details/<?= base64_encode($sale->id); ?>" class="badge border border-info text-info bg-transparent"><i class="fa-solid fa-file fa-fw"></i></a>

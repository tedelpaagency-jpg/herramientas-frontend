                                       ...
                                       <table class="table text-nowrap" id="dataTable">
                                            <thead>
                                                <tr class="fw-700 font-xssss text-grey-900 pt-3 pb-3 ">
                                                    ...
                                                    <th class="border-0 py-2">Gerente Comercial</th>
                                                ...
                                                <?php 
                                                  ...
                                                  <tr>
                                                    <td>
                                                        ...
                                                        <td>
                                                             <?php if($sale->commition_percent_director == ''): ?><span class="badge border border-warning text-warning bg-transparent">Pendiente</span><?php else: ?><span class="badge border border-success text-success bg-transparent">$<?php  echo number_format($sale->commition_percent_director,2,'.',',');?></span><?php endif; ?>
                                                        </td>
                                                        <td>
                                                             <?php if($sale->commition_percent_empresa == ''): ?><span class="badge border border-warning text-warning bg-transparent">Pendiente</span><?php else: ?><span class="badge border border-success text-success bg-transparent">$<?php  echo number_format($sale->commition_percent_empresa,2,'.',',');?></span><?php endif; ?>
                                                        </td>

                ...
                <div id="photo-grid" class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 mb-5">
                    ...
                    <div class="photo-card reveal-card bg-white rounded-3xl overflow-hidden border border-slate-100 shadow-sm flex flex-col" style="animation-delay: 0ms;">
                        ...
                        <div class="p-3 md:p-4 space-y-3">
                            ...
                            <button onclick="startEpicDownload('<?= $canva['id']; ?>', this)" class="w-full glass-button text-white py-2.5 rounded-xl text-[9px] font-black uppercase tracking-widest hover:bg-indigo-600 transition-all flex items-center justify-center gap-2 shadow-lg" style="background:#002d65 !important;">
                                <i class="fas fa-download"></i>
                                <span>BAJAR</span>
                            </button>
                            <button onclick="copymsg('<?= $canva['message']; ?>', this)" class="w-full glass-button text-white py-2.5 rounded-xl text-[9px] font-black uppercase tracking-widest hover:bg-indigo-600 transition-all flex items-center justify-center gap-2 shadow-lg" style="background:#0500ff !important;">
                                <i class="fas fa-download"></i>
                                <span>COPIAR INF</span>
                            </button>
                            <?php if($canva['link'] != ''): ?>
                            <a href="<?= $canva['link']; ?>" target="_blank" class="w-full glass-button text-white py-2.5 rounded-xl text-[9px] font-black uppercase tracking-widest hover:bg-indigo-600 transition-all flex items-center justify-center gap-2 shadow-lg" style="background:#ff6000 !important;">
                                <i class="fas fa-download"></i>

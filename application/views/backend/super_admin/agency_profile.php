                        ...
                        <div class="card  shadow-xss rounded-xxl border-0 mb-3 mt-3">
                            ...
                            <div class="card-body  pt-0 ps-4 pe-4 pb-3 ">
                                ...
                                <form method="post" action="<?=  base_url('portal/agencies/saveAgency'); ?>" enctype="multipart/form-data" class="row">
                                    ...
                                    <div class="col-md-12">
                                        <label class="mont-font fw-600 font-xsss" for="validationCustom01">Nombre de la tienda</label>
                                     ...
                                     <div class="col-md-12">
                                        <label class="mont-font fw-600 font-xsss" for="validationCustom01">Descripción</label>
                                    ...
                                    <div class="col-md-12">
                                        <label class="mont-font fw-600 font-xsss" for="validationCustom01">Dirección completa</label>
                                    ...
                                    <div class="col-md-6">
                                        <label class="mont-font fw-600 font-xsss" for="validationCustom01">Número de teléfono</label>
                                    ...
                                    <div class="col-md-6">
                                        <label class="mont-font fw-600 font-xsss" for="validationCustom01">Correo electrónico</label>
                                    ...
                                    <div class="col-md-4">
                                        <label class="mont-font fw-600 font-xsss" for="validationCustom01">Costo Adicional a productos</label>
                                    ...
                                    <div class="col-md-4">
                                        <label class="mont-font fw-600 font-xsss" for="validationCustom01">Costo de envio</label>
                                    ...
                                    <div class="col-md-4">
                                        <label class="mont-font fw-600 font-xsss" for="validationCustom01">Costo adicional de envio</label>
                                    ...
                                    <div class="col-md-6">
                                        <label class="mont-font fw-600 font-xsss" for="validationCustom01">Comision de gerente comercial</label>
                                        <input class="form-control" id="validationCustom01" placeholder="" value="<?= $agency['gerent_commition_percent']; ?>" required="" value="" name="gerent_commition_percent" type="text" />
                                       
                                    </div>
                                    <div class="col-md-6">
                                        <label class="mont-font fw-600 font-xsss" for="validationCustom01">Comision de agencia</label>
                                        <input class="form-control" id="validationCustom01" placeholder="" value="<?= $agency['commition_percent']; ?>" required="" value="" name="commition_percent" type="text" />
                                    </div>
                                    <div class="col-md-4">
                                        <label class="mont-font fw-600 font-xsss" for="validationCustom01">Facebook</label>
                                    ...
                                    <div class="col-md-4">
                                        <label class="mont-font fw-600 font-xsss" for="validationCustom01">Instagram</label>
                                    ...
                                    <div class="col-md-4">
                                        <label class="mont-font fw-600 font-xsss" for="validationCustom01">Ticktock</label>
                                    ...
                                    <div class="col-12">
                                         <div class="mb-3">
                                             <label class="mont-font fw-600 font-xsss">Visitador medico</label>
                                             <select class="form-select select2" name="gerente_id"  style="width:100%">
                                                 <option value="">Seleccionar</option>
                                                 <?php $users = $this->db->where('status',1)->where('rol_id',2)->get('user')->result(); ?>
                                                 <?php foreach ($users as $user): ?>
                                                 <option value="<?= $user->user_id; ?>" <?= $user->user_id == $agency['gerente_id'] ? 'Selected':''; ?>><?= $user->name.' '.$user->last_name.'('.$user->phone.')'; ?></option>
                                                 <?php endforeach; ?>
                                             </select>
                                         </div>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <label class="mont-font fw-600 font-xsss" for="validationCustom01">Proveedores</label>
                                        <select class="form-control select2 w100" name="suppliers[]" multiple="" style="width:100%">
                                            <?php $suppliers_selected = json_decode($agency['suppliers'],true); ?>        
                                            <?php $suppliers = $this->db->get_where('user',['status'=>1,'rol_id'=>6])->result_array(); ?>
                                            <?php foreach($suppliers as $supplier): ?>
                                            <option value="<?= $supplier['user_id']; ?>" <?php if(in_array($supplier['user_id'],$suppliers_selected)) echo 'selected'; ?>>

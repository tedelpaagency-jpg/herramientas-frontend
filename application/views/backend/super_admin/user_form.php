...
<div class="modal-body row">
        ...
        <div class="<?= $param3 != 2 ? 'col-sm-12':'col-sm-4'; ?> ">
        ...
        <?php if($param3 == 2): ?>
        <div class="<?= $param3 != 2 ? 'col-sm-6':'col-sm-4'; ?> ">
            <div class="avatar-upload">
                <label>Logo Agencias</label>
                <div class="avatar-edit">
                    <input type="file" name="photo" id="imageUpload2" class="imageUpload" data-preview="#preview2" accept=".png, .jpg, .jpeg">
                    <label for="imageUpload2"></label>
                </div>
                <div class="avatar-preview" style="border: 2px solid #198cff8f;">
                    <div id="preview2" style="background-image: url(<?php echo $this->crud_model->getPhoto('user',$user->user_id); ?>);">
                    </div>
                </div>
            </div>
        </div>
        <div class="<?= $param3 != 2 ? 'col-sm-6':'col-sm-4'; ?> ">
            <div class="avatar-upload">
                <label>Logo 3</label>
                <div class="avatar-edit">
                    <input type="file" name="photo" id="imageUpload3" class="imageUpload" data-preview="#preview3" accept=".png, .jpg, .jpeg">
                    <label for="imageUpload3"></label>
                </div>
                <div class="avatar-preview" style="border: 2px solid #198cff8f;">
                    <div id="preview3" style="background-image: url(<?php echo $this->crud_model->getPhoto('user',$user->user_id); ?>);">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="form-group">
                <label for="email" class="mont-font fw-600 font-xsss">Adicional</label>
            ...
            <div class="form-group mb-3">
                ...
                <select class="form-control" data-choices name="company_id" id="choices-single-default">
                    ...
                    <?php
                        ...
                        foreach($com as $c):
                    ?>
                            <option value="<?= $c['email_templates_id']; ?>" <?php if(isset($user)) { echo $user->email_templates_id == $c['id'] ? 'selected':''; } ?>><?= $c['name']; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
       </div>

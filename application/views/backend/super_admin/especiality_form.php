...
<?php $row = $this->db->get_where('specialties',['id'=>$param2])->row_array(); ?>
<form action="<?php echo base_url(); ?>portal/specialties/save" method="post" id="idForm" enctype="multipart/form-data">

                    ...
                    <div class="card w-100 border-0 p-0 bg-white shadow-xss rounded-xxl">
                        ...
                        <div class="card-body d-block w-100 shadow-none mb-0 p-0 border-top-xs">
                            <ul class="nav nav-tabs h55 d-flex product-info-tab border-bottom-0 ps-4" id="pills-tab" role="tablist">
                                ...
                                <li class="list-inline-item me-5"><a class="fw-700 font-xssss text-grey-500 pt-3 pb-3 ls-1 d-inline-block" href="#navtabs2" data-bs-toggle="tab">Agencias</a></li>
                    ...
                    <div class="tab-content" id="myTabContent">
                                            ...
                                            <div class="card-container payoneer-card">
                                                ...
                                                <div class="card-footer">
                                                    ...
                                                    <div class="holder-info">
                                                        ...
                                                        <div class="holder-name"><?= $this->crud_model->getName('user',$this->session->userdata('login_user_id')); ?></div>
                                                    </div>
                                ...
                                <div class="col-lg-6 pe-2 ps-2">
                                    <div class="card w-100 border-0 shadow-none p-4 rounded-xxl  mb-3" style="background-color: #f6f3ff;">
                                        <div class="card-body d-flex p-0">
                                            ...
                                            <h4 class="text-secondary font-xl fw-700">0 <span class="fw-500 mt-0 d-block text-grey-500 font-xssss">Balance Actual</span></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 pe-2 ps-2">
                                    <div class="card w-100 border-0 shadow-none p-4 rounded-xxl mb-3" style="background-color: #e2f6e9;">
                                        <div class="card-body d-flex p-0">
                                            ...
                                            <h4 class="text-success font-xl fw-700">0 <span class="fw-500 mt-0 d-block text-grey-500 font-xssss">Total de Puntos</span></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 ps-2">
                                    <div class="card w-100 border-0 shadow-none p-4 rounded-xxl mb-3" style="background-color: #fff0e9;">
                                        <div class="card-body d-flex p-0">
                                            ...
                                            <h4 class="text-warning font-xl fw-700">0 <span class="fw-500 mt-0 d-block text-grey-500 font-xssss">Total de Visas</span></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                      ...
                      <div class="tab-pane fade p-3" id="navtabs2" role="tabpanel">
                        <div class="card  shadow-xss rounded-xxl border-0 mb-3 mt-3">
                            <div class="card-body d-flex align-items-center  p-4">
                                <h4 class="fw-700 mb-0 font-xssss text-grey-900">Agencias</h4>
                            </div>
                            <div class="card-body  pt-0 ps-4 pe-4 pb-3 ">
                                <div class="table-responsive">
                                   <table class="table table-striped text-nowrap" id="sale_data">
                                        ...
                                        <tbody>
                                            <?php $agencies = $this->db->get_where('agency',['status !='=>0,'gerente_id'=>$user['user_id']])->result(); ?>
                                            <?php foreach($agencies as $agency): ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $agency->status == 1 ? '<span class="badge border border-primary text-primary bg-transparent">Activo</span>':'<span class="badge border border-danger text-danger bg-transparent">Suspendido</span>'; ?></td>
                                                    <td>
                                                        <a href="<?= base_url(); ?>portal/agency_profile/<?= base64_encode($agency->id); ?>"  class="badge border border-primary text-primary bg-transparent"><i class="ti ti-clipboard"></i></a>
                        ...
                        <div class="card  shadow-xss rounded-xxl border-0 mb-3 mt-3">
                            ...
                            <div class="card-body  pt-0 ps-4 pe-4 pb-3 ">
                                ...
                                <form id="userForm" method="post" action="<?php echo base_url('portal/users/save/'.$user['user_id']); ?>" enctype="multipart/form-data" class="row">
                                    ...
                                    <div class="<?= $user['rol_id'] != 2 ? 'col-sm-6':'col-sm-4'; ?> ">
                                        <div class="avatar-upload">
                                            <label>Avatar</label>
                                            <div class="avatar-edit">
                                                <input type="file" name="photo" id="imageUpload" class="imageUpload" data-preview="#preview1" accept=".png, .jpg, .jpeg">
                                                <label for="imageUpload"></label>
                                            </div>
                                            <div class="avatar-preview" style="border: 2px solid #198cff8f;">
                                                <div id="preview1" style="background-image: url(<?php echo $this->crud_model->getPhoto('user',$user['user_id']); ?>);">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <?php if($user['rol_id'] == 2): ?>
                                        <div class="<?= $user['rol_id'] != 2 ? 'col-sm-6':'col-sm-4'; ?> ">
                                            <div class="avatar-upload">
                                                <label>Logo Agencias</label>
                                                <div class="avatar-edit">
                                                    <input type="file" name="photo_2" id="imageUpload2" class="imageUpload" data-preview="#preview2" accept=".png, .jpg, .jpeg">
                                                    <label for="imageUpload2"></label>
                                                </div>
                                                <div class="avatar-preview" style="border: 2px solid #198cff8f;">
                                                    <div id="preview2" style="background-image: url(<?php echo $this->crud_model->getPhoto2('user',$user['user_id']); ?>);">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="<?= $user['rol_id'] != 2 ? 'col-sm-6':'col-sm-4'; ?> ">
                                            <div class="avatar-upload">
                                                <label>Logo 3</label>
                                                <div class="avatar-edit">
                                                    <input type="file" name="photo_3" id="imageUpload3" class="imageUpload" data-preview="#preview3" accept=".png, .jpg, .jpeg">
                                                    <label for="imageUpload3"></label>
                                                </div>
                                                <div class="avatar-preview" style="border: 2px solid #198cff8f;">
                                                    <div id="preview3" style="background-image: url(<?php echo $this->crud_model->getPhoto3('user',$user['user_id']); ?>);">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control" id="email" name="address" rows="3" ><?= $user['address']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            <label for="phone" class="mont-font fw-600 font-xsss">Plantilla de email</label>
                                            <select class="form-control" data-choices name="email_templates_id" id="choices-single-default">
                                                <option value="">Seleccionar</option>
                                                <?php
                                                    $com = $this->db->get_where('email_templates')->result_array();
                                                    foreach($com as $c):
                                                ?>
                                                        <option value="<?= $c['id']; ?>" <?php if(isset($user)) { echo $user['email_templates_id'] == $c['id'] ? 'selected':''; } ?>><?= $c['name']; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                   </div>
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary text-center  text-white" id="btnsubmit">Guardar</button>
                                    </div>
                                </form>
                ...
                <div class="col-lg-12">
                    <div class="card w-100 border-0 p-0 bg-white shadow-xss rounded-xxl">
                        ...
                        <div class="card-body d-block w-100 shadow-none mb-0 p-0 border-top-xs">
                            <ul class="nav nav-tabs h55 d-flex product-info-tab border-bottom-0 ps-4" id="pills-tab" role="tablist">
                                <li class="active list-inline-item me-5"><a class="fw-700 font-xssss text-grey-500 pt-3 pb-3 ls-1 d-inline-block active" href="#navtabs1" data-bs-toggle="tab">Estadísticas</a></li>
                                <li class="list-inline-item me-5"><a class="fw-700 font-xssss text-grey-500 pt-3 pb-3 ls-1 d-inline-block" href="#navtabs2" data-bs-toggle="tab">Ventas</a></li>
                                <?php $user_profile = $this->db->get_where('user_profile',['user_id'=>$user_id]); ?>
                                <?php if($user_profile->num_rows() > 0): ?>
                                <li class="list-inline-item me-5"><a class="fw-700 font-xssss text-grey-500 pt-3 pb-3 ls-1 d-inline-block" href="#navProfile" data-bs-toggle="tab">Micro Site</a></li>
                                <?php endif; ?>
                ...
                <div class="col-lg-12">
                    <div class="tab-content" id="myTabContent">
                      ...
                      <div class="tab-pane fade p-3" id="navtabs2" role="tabpanel">
                        <div class="card  shadow-xss rounded-xxl border-0 mb-3 mt-3">
                            <div class="card-body d-flex align-items-center  p-4">
                                <h4 class="fw-700 mb-0 font-xssss text-grey-900">Ventas generadas</h4>
                            </div>
                            <div class="card-body  pt-0 ps-4 pe-4 pb-3 ">
                                <div class="table-responsive">
                                   <table class="table table-striped text-nowrap" id="sale_data">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach($sales as $sale): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                         <?php if($sale->total_commissionable == ''): ?><span class="badge border border-warning text-warning bg-transparent">Pendiente</span><?php else: ?><span class="badge border border-success text-success bg-transparent">$<?= $sale->total_commissionable; ?></span><?php endif; ?>
                                                    </td>
                                                    
                                                     <td>
                                                         <?php if($sale->status == 0): ?><span class="badge border border-warning text-warning bg-transparent">Pendiente</span>
                                                         <?php elseif($sale->status == 1): ?><span class="badge border border-success text-success bg-transparent">Pagado</span>
                                                         <?php elseif($sale->status == 2): ?><span class="badge border border-danger text-danger  bg-transparent">Rechazado</span>
                                                         <?php endif; ?>
                                                    </td>
                                                    
                                                    <td>
                                                         <a  href="<?= base_url(); ?>portal/detailssale/<?= base64_encode($sale->sale_id); ?>" class="btn btn-sm btn-soft-secondary me-1"><i class='ti ti-clipboard'></i></a>
                                                         <?php if($sale->status == 0):?>
                                                         <a  href="<?= base_url(); ?>portal/newreportsale/<?= base64_encode($sale->sale_id); ?>" class="btn btn-sm btn-soft-secondary me-1"><i class="ti ti-pencil fs-16"></i></a>
                                                           <a  class="btn btn-sm btn-soft-danger" onclick="delete_element('portal/detailssale/delete/<?= base64_encode($sale->sale_id); ?>')"><i class="ti ti-trash fs-16"></i></a>
                                                         <?php endif; ?>
                      ...
                      <?php if($user_profile->num_rows() > 0): ?>
                        ...
                        <div class="tab-pane fade p-3" id="navProfile" role="tabpanel">
                            <div class="card  shadow-xss rounded-xxl border-0 mb-3 mt-3">
                                <div class="card-body p-4 w-100 bg-current border-0 d-flex rounded-3 mb-3">
                                    <div class="border-0 d-flex">
                                        <h4 class="font-xs text-white fw-600 ms-4 mb-0 mt-2" id="exampleModalLabel">Editar Micro Site</h4>    
                                    </div>
                                </div>
                                <div class="card-body  pt-0 ps-4 pe-4 pb-3 ">
                                    <form class="app-form row g-3 needs-validation"
                                          ...
                                          novalidate>
                                    <?php $profile = $this->db->get_where('user_profile',['user_id'=>$user_id])->row_array(); ?>
                                    <input type="hidden" name="user_id" value="<?= $user_id; ?>" />
                                      ...
                                      <div class="col-md-12">
                                        ...
                                        <textarea name="location" class="form-control" rows="4" style="height:120px; line-height: normal !important;"><?= @$profile['location']; ?></textarea>
                                      </div>
                                      ...
                                      <div class="col-md-12">
                                        ...
                                        <!-- Sitio web -->
                                      <div class="col-md-12">
                                        <label class="form-label">Link de Whatsapp</label>
                                        <input type="url" name="whatsapp_link" class="form-control" value="<?= @$profile['whatsapp_link']; ?>">
                                      </div>
                                      
                                      <!-- Bio -->
                                      <div class="col-md-12">
                                        <label class="form-label">Biografía</label>
                                        <textarea name="bio" class="form-control" rows="4"  style="height:120px;line-height: normal !important;"><?= @$profile['bio']; ?></textarea>
                                      </div>
                                      ...
                                      <div class="col-md-4">
                                        ...
                                        <input type="text" name="tiktok" class="form-control" value="<?= @$profile['tiktok']; ?>">
                                      </div>
                                      <!-- Botón -->
                            ...
                            <div class="card  shadow-xss rounded-xxl border-0 mb-3 mt-3">
                                <div class="card-body p-4 w-100 bg-current border-0 d-flex rounded-3 mb-3">
                                    <div class="border-0 d-flex">
                                        <h4 class="font-xs text-white fw-600 ms-4 mb-0 mt-2" id="exampleModalLabel">Galería <?= $profile['id'] ?></h4>    
                                    </div>
                                </div>
                                <style>
                                    .gallery-card {
                                ...
                                <div class="card-body  pt-0 ps-4 pe-4 pb-3 ">
                                    <div class="col-md-12 gallery-card">
                                        <div class="mb-3">
                                            <label>Galería (máx. 6 imágenes)</label>
                                            <input type="file" id="galleryInput" multiple accept="image/*" class="form-control">
                                        </div>
                                        
                                        <div id="galleryPreview" class="row g-3">
                                            <?php $images = $this->db->get_where('user_profile_gallery',['user_profile_id' =>$profile['id']])->result_array(); ?>
                                            <?php foreach($images as $img): ?>
                                                <div class="col-4" id="img-<?= $img['id']; ?>">
                                                    <div class="gallery-item">
                                                        <img src="<?= base_url("uploads/profile/") ?><?= $img['image']; ?>">
                                        ...
                                        <script>
                                            ...
                                            $('#galleryInput').on('change', function () {
                                                ...
                                                if ((files.length + currentCount) > MAX_IMAGES) {
                                                ...
                                                $.each(files, function (i, file) {
                                                    ...
                                                    formData.append('names[]', file.name);
                                                     // loader visual inmediato
                                                });
                                            
                                                formData.append('profile_id', <?= $profile['id'] ?>);
                                            
                                                $.ajax({
                                                    url: '<?= base_url("portal/card_edit/upload_gallery_ajax") ?>',
                                                    type: 'POST',
                                                    data: formData,
                                                    processData: false,
                                                    contentType: false,
                                            ...
                                            function addTempLoader() {
                                                $('#galleryPreview').append(`
                                                    <div class="col-4 temp-loader">
                                                        <div class="gallery-item" style="    height: 120px;">
                                            ...
                                            function deleteImage(id) {
                                                ...
                                                $('#img-'+id+' .gallery-item').append(`
                                                    <div class="loader"><div class="spinner"></div></div>
                                                `);
                                            
                                                $.post('<?= base_url("portal/card_edit/delete_image_ajax") ?>', {id:id}, function () {
                                                    $('#img-'+id).remove();
                                                    currentCount--;
                                                });
                                            }
                                ...
                                <form id="userForm" method="post" action="<?php echo base_url('portal/users/save/'.$user['user_id']); ?>" enctype="multipart/form-data" class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <br>
                                            <textarea class="form-control" id="email" name="address" rows="3" ><?= $canton['address']; ?></textarea>
                                        </div>
                                    </div>

...
<?php 
    if(isset($param2))
    $user = $this->db->get_where('canvas',array('id'=>$param2))->row();
?>
<style>
    .avatar-upload {
  position: relative;
...
<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel"><?php echo isset($user) ? 'Actualizar canva' : 'Agregar canva'; ?></h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
 <form method="post" action="<?php echo base_url('portal/canvas/saveCanva/'); ?>" enctype="multipart/form-data">
            ...
            <div class="col-sm-12 ">
                <div class="avatar-upload">
                    ...
                    <div class="avatar-preview" style="border: 2px solid #198cff8f;">
                        <div id="imagePreview" style="background-image: url(<?php echo $this->crud_model->getPhotoCanvas('canvas',$user->id); ?>);">
                        </div>
                    </div>
                </div>
            </div>

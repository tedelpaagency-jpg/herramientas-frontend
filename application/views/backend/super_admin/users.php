                ...
                <div class="card shadow-xss w-100 d-block d-flex border-0 p-4 mb-3">
                    <div class="card-body d-flex align-items-center p-0">
                        <h2 class="fw-700 mb-0 mt-0 font-md text-grey-900">
                            <?= $this->db->get_where('rol',['rol_id'=>$rol_id])->row()->name; ?></h2>
                        ...
                        <a href="javascript:void(0)"
                            onclick="showAjaxModal('<?= base_url(); ?>modal/popup/user_form/0/<?= $rol_id; ?>')"
                            data-toggle="modal"
                    ...
                    <div class="card  shadow-xss rounded-xxl border-0 mb-3 mt-3">
                        <div class="card-body d-flex align-items-center p-4">
                            <h4 class="fw-700 mb-0 font-xssss text-grey-900">
                                <?= $this->db->get_where('rol',['rol_id'=>$rol_id])->row()->name; ?></h4>
                        </div>
                        <div class="card-body  pt-0 ps-4 pe-4 pb-3 ">
                            <div class="table-responsive">
                                <table class="table " id="sale_data">
                                    ...
                                    <tbody>
                                        <?php $users = $this->db->get_where('user',['rol_id'=>$rol_id,'status !='=>0])->result(); ?>
                                        ...
                                        <tr>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="fs-14 m-0 fw-normal">
                                                            <?php echo $user->name.' '.$user->last_name; ?></h5>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <a href="<?= base_url(); ?>portal/user_profile/<?= base64_encode($user->user_id); ?>"
                                                    class="badge border border-primary text-primary bg-transparent icon-btn b-r-4"><i
                ...
                <div class="card shadow-xss w-100 d-block d-flex border-0 p-4 mb-3">
                    <div class="card-body d-flex align-items-center p-0">
                        ...
                        <a href="#" class="btn-round-md ms-2 bg-greylight theme-dark-bg rounded-3"><i
                                class="feather-filter font-xss text-grey-500"></i></a>
                        <a href="javascript:void(0)"
                            onclick="showAjaxModal('<?= base_url(); ?>modal/popup/hunter_form/0/<?= $rol_id; ?>')"
                            data-toggle="modal"
                            class="btn-round-md ms-2 bg-success theme-dark-bg rounded-3 text-white"><i
                                class="feather-plus-circle font-xss "></i></a>
                    </div>
                                ...
                                <table class="table " id="sale_data">
                                    ...
                                    <tbody>
                                        ...
                                        <?php 
                                                ...
                                                $form = $this->db->get_where('forms',['user_id'=>$user->user_id])->row();
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="fs-14 m-0 fw-normal">
                                                            <?php echo $user->name.' '.$user->last_name.' '.$form->user_id; ?>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td><?php echo $user->username; ?></td>
                                            <td>
                                                <a href="<?= base_url('public/form_qr/'.$form->qr)?>"><img
                                                        src="<?= base_url('public/form_qr/'.$form->qr)?>"
                                                        width="50px;"></a>
                                            </td>
                                            <td>
                                                <div class="input-group">
                                                    <input type="text" class="form-control"
                                                        value="<?= base_url('form?campaign='.base64_encode($form->forms_id)); ?>">
                                            ...
                                            <td>
                                                <a href="<?= base_url().'portal/requests/'.base64_encode($form->forms_id); ?>"
                                                    class="badge border border-success text-success bg-transparent icon-btn b-r-4"><i
                                                        class="ti ti-file "></i></a>
                                                <a href="<?= base_url(); ?>portal/hunter_profile/<?= base64_encode($user->user_id); ?>"
                                                    class="badge border border-primary text-primary bg-transparent icon-btn b-r-4"><i
                                                        class="ti ti-user"></i></a>
                                            </td>
                                        </tr>
                ...
                <div class="card shadow-xss w-100 d-block d-flex border-0 p-4 mb-3">
                    <div class="card-body d-flex align-items-center p-0">
                        ...
                        <a href="#" class="btn-round-md ms-2 bg-greylight theme-dark-bg rounded-3"><i
                                class="feather-filter font-xss text-grey-500"></i></a>
                        <a href="javascript:void(0)"
                            onclick="showAjaxModal('<?= base_url(); ?>modal/popup/user_form/0/2')" data-toggle="modal"
                            class="btn-round-md ms-2 bg-success theme-dark-bg rounded-3 text-white"><i
                                class="feather-plus-circle font-xss "></i></a>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 col-sm-6 pe-2 ps-2">
                        <div class="card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3">
                            <div class="card-body position-relative h100 bg-image-cover bg-image-center"
                                style="background-image: url(https://uicobe.com/html/sociala/images/e-4.jpg);"></div>
                            <div class="card-body d-block w-100 pl-10 pe-4 pb-4 pt-0 text-left position-relative">
                                <figure class="avatar position-absolute w75 z-index-1" style="top:-40px; left: 15px;">
                                    <img src="<?= base_url(); ?>public/assets/images/users/<?= $user['photo']; ?>"
                                ...
                                <span class="position-absolute right-15 top-0 d-flex align-items-center">
                                    <a href="<?= base_url(); ?>portal/user_profile/<?= base64_encode($user['user_id']); ?>"
                                        class="text-center p-2 lh-24 w100 ms-1 ls-3 d-inline-block rounded-xl bg-current font-xsssss fw-700 ls-lg text-white">PERFIL</a>
                                </span>
                            </div>
                        </div>
                    </div>

                                                ...
                                                <div class="col-lg-3 pe-2 ps-2">
                                                    <div class="card w-100 border-0 shadow-none p-4 rounded-xxl  mb-3" style="background-color: #f6f3ff;">
                                                        <div class="card-body d-flex p-0">
                                                            ...
                                                            <h4 class="text-secondary font-xl fw-700"><?= $this->tasks_model->countAppointments($date, '0');?> <span class="fw-500 mt-0 d-block text-grey-500 font-xssss">Tareas Pendientes</span></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 pe-2 ps-2">
                                                    <div class="card w-100 border-0 shadow-none p-4 rounded-xxl mb-3" style="background-color: #e2f6e9;">
                                                        <div class="card-body d-flex p-0">
                                                            ...
                                                            <h4 class="text-success font-xl fw-700"><?= $this->tasks_model->countAppointments($date, 1);?> <span class="fw-500 mt-0 d-block text-grey-500 font-xssss">Tareas Completadas</span></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 ps-2">
                                                    <div class="card w-100 border-0 shadow-none p-4 rounded-xxl mb-3" style="background-color: #fff0e9;">
                                                        <div class="card-body d-flex p-0">
                                                            ...
                                                            <h4 class="text-warning font-xl fw-700"><?= $this->tasks_model->countAppointments($date, 2);?> <span class="fw-500 mt-0 d-block text-grey-500 font-xssss">Tareas que Cancelaron</span></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

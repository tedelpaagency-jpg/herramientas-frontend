                        ...
                        <div class="col-xl-12">
                            <div class="card shadow-xss w-100 d-block d-flex border-0 p-4 mb-3">
                                <div class="card-body d-flex align-items-center p-0">
                                    <h2 class="fw-700 mb-0 mt-0 font-md text-grey-900">Citas</h2>
                                    ...
                                    <a href="<?= base_url('portal/appointments/add'); ?>" class="btn-round-md ms-2 bg-success theme-dark-bg rounded-3 text-white"><i class="feather-plus-circle font-xss "></i></a>
                                </div>
                            </div>

                            <div class="card  shadow-xss rounded-xxl border-0 mb-3 mt-3">
                                <div class="card-body d-flex align-items-center  p-4">
                                    <h4 class="fw-700 mb-0 font-xssss text-grey-900">Listado de citas</h4>
                                </div>
                                                ...
                                                <div class="col-lg-3 pe-2">
                                                    <div class="card w-100 border-0 shadow-none p-4 rounded-xxl  mb-3" style="background-color: #e5f6ff;">
                                                        <div class="card-body d-flex p-0">
                                                            ...
                                                            <h4 class="text-primary font-xl fw-700"><?= $this->tasks_model->countAppointments($date,'T');?><span class="fw-500 mt-0 d-block text-grey-500 font-xssss">Todas las Citas</span></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                         ...
                                         <div class="tabs-content active" id="tab-1">
                                             <div class="mail-table">
                                                 <?php 
                                                    ...
                                                    // Agrupar citas por hora (de 6 AM a 6 PM)
                                                    $groupedAppointments = [];
                                                    ...
                                                    foreach ($tasks as $task) {
                                                        $hour = date('H:00', strtotime($task->appointment_time)); // Extrae la hora en formato "HH:00"
                                                            ...
                                                            <div class="hour-section">
                                                                <ul class="list-inline mb-4">
                                                                    <li class="list-inline-item d-block border-bottom me-0">
                                                                        <a href="javascript:void(0)" class="py-1 d-flex align-items-center">
                                                                            <i class="btn-round-sm bg-primary-gradiant text-white feather-clock font-xss me-2"></i>
                                                                            <b><?= $hour; ?></b>
                                                                        </a>
                                                                    </li>
                                                                </ul>
                                                                ...
                                                                <div class="card-body d-flex align-items-start pt-0 ps-4 pe-4 pb-3 overflow-visible">
                                                                    <div class="<?= $st; ?> me-2 p-3 rounded-xxl text-center">
                                                                        <h4 class="fw-700 font-lg ls-3 lh-1 text-white mb-0">
                                                                            <span class="d-block font-xsss fw-600 uppercase">
                                                                                <?= date('M', strtotime($task->appointment_date)); ?>
                                                                            </span>
                                                                            <?= date('d', strtotime($task->appointment_date)); ?>
                                                                            <br>
                                                                            <span class="d-block font-xsss fw-600 uppercase">
                                                                                <?= date('H:i', strtotime($task->appointment_time)); ?>
                                                                            </span>
                                                                        </h4>
                                                                    </div>
                                                                    ...
                                                                    <h4 class="fw-700 text-grey-900 font-xssss mt-2 flex-grow-1">
                                                                        ...
                                                                        <span class="d-block font-xsssss fw-500 mt-1 lh-4 text-grey-500">
                                                                            <?= "Doctor: ".$this->crud_model->getName('user',$task->doctor_id); ?><br>
                                                                            <?php if($task->patient_id != '0') echo "Cliente: ".$this->crud_model->getName('user',$task->patient_id); ?>
                                                                        </span>
                                                                    </h4>
                                                                        ...
                                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                                            ...
                                                                            <li>
                                                                                <a class="dropdown-item"
                                                                                   href="<?= base_url('portal/appointments/edit/'.$task->id); ?>">
                                                                                    Editar
                                                                                </a>
                                                                            </li>
                                                                            ...
                                                                            <li>
                                                                                <a class="dropdown-item text-success"
                                                                                   href="<?= base_url('portal/appointments/attend/'.$task->id); ?>">
                                                                                    Atender
                                                                                </a>
                                                                            </li>
                                                                            ...
                                                                            <li>
                                                                                <a class="dropdown-item text-danger"
                                                                                   href="<?= base_url('portal/appointments/delete/'.$task->id); ?>">
                                                                                    Cancelar
                                                                                </a>
                                                                            </li>

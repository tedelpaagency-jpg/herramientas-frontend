                                    ...
                                    <?php foreach($stories as $story): ?>
                                        ...
                                        <div class="col-md-3 col-xss-6 pe-2 ps-2" onclick="showAjaxModalStories('<?= base_url(); ?>modal/popup/modal_storie/<?= $story['id']; ?>')">
                                             <div class="card h300 d-block border-0 shadow-xss rounded-3 bg-gradiant-bottom overflow-hidden mb-3 bg-image-cover" >
                                                 <div class="card-body d-block w-100 position-absolute  e-10 text-right z-index-1">
                                                    <a  href="javascript:void(0)" onclick="event.stopPropagation(); delete_item('portal/feed/delete_post/<?= base64_encode($story['id']); ?>')" class="btn-round-sm bg-danger text-white feather-trash font-xss ms-auto mt-2"></a>
                                                </div>
                                                 <?php if ($is_video): ?>

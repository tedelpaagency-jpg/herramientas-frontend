        ...
        <div class="middle-sidebar-left">
             <div class="card  shadow-xss rounded-xxl border-0 mb-3 mt-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <input class="form-control" id="validationCustom01" placeholder="Nombre de la tienda" required="" value="<?php echo $this->crud_model->getInfo('name'); ?>" name="name" type="text" />

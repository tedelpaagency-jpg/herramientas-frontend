    ...
    <style>
        ...
        body { 
            ...
            color: #0f172a;
            overflow-x: hidden;
            padding-bottom: 120px; /* Espacio para el carrito horizontal */
        }
...
<div class="middle-sidebar-bottom">
    ...
    <script>
        ...
        const modules = [
            { id: 'ventas', name: 'Ventas', icon: 'ventas', color: '#3b82f6', desc: 'Control de facturación, presupuestos y proyecciones de ingresos.', priceEC: 0, pricePE: 45 },
            { id: 'viajes', name: 'Viajes', icon: 'viajes', color: '#6366f1', desc: 'Gestión de viáticos, rutas y reservas corporativas.', priceEC: 35, pricePE: 37 },
            { id: 'contratos', name: 'Contratos', icon: 'contratos', color: '#10b981', desc: 'Repositorio legal con firma electrónica y avisos de vencimiento.', priceEC: 10, pricePE: 55 },
            { id: 'visas', name: 'Visas', icon: 'visas', color: '#f59e0b', desc: 'Asesoría y seguimiento de procesos migratorios laborales.', priceEC: 15, pricePE: 92 },
            { id: 'regalos', name: 'Regalos', icon: 'regalos', color: '#f43f5e', desc: 'Gestión de incentivos y programas de fidelización.', priceEC: 0, pricePE: 30 },
            ...
            { id: 'campañas', name: 'Campañas', icon: 'campañas', color: '#06b6d4', desc: 'Marketing masivo y comunicación estratégica segmentada.', priceEC: 15, pricePE: 74 },
            { id: 'agendamiento', name: 'Agenda', icon: 'agendamiento', color: '#14b8a6', desc: 'Citas, reservas y gestión de tiempo profesional.', priceEC: 10, pricePE: 33 },
            { id: 'tareas', name: 'Tareas', icon: 'tareas', color: '#f97316', desc: 'Productividad de equipos y gestión de proyectos por hitos.', priceEC: 10, pricePE: 26 },
            { id: 'tikvao', name: 'Micro Site', icon: 'tikvao', color: '#1e293b', desc: 'Tu identidad digital en un solo enlace: Video y contacto.', priceEC: 10, pricePE: 19 }
        ];

...
<head>
  ...
  <title>Formulario Visa Canadiense </title>
...
<body>
    ...
    <img src="<?= base_url(); ?>public/assets/images/logo/<?= $agency['logo']; ?>g" 
  ...
  <div class="container">
    <form id="visaForm">
      <h3 class="text-center mb-4 text-white">Formulario - Visa Canadiense</h3>
      ...
      <div class="border p-4">
        ...
        <div class="form-row mt-2">
          <div class="col-md-12"><input type="text" class="form-control" name="address_in_usa" placeholder="Dirección en Canadá"></div>
        </div>
      ...
      <div class="border p-4">
        ...
        <!-- 3. ¿Mantiene o ha mantenido una licencia de conducir en los Canadá? -->
        <div class="form-row mt-2">
          <div class="col-md-6">
            <select class="form-control toggle-target" name="has_usa_licence" id="has_usa_licence" data-rules='[{"target":"hul","value":"Sí"}]'>
              <option value="">¿Mantiene o ha mantenido una licencia de conducir en los Canadá?</option>
              <option>Sí</option>
              <option>No</option>
            </select>
          </div>
        ...
        <!-- 5. ¿Alguna vez se le ha emitido una visa canadiense? -->
        <div class="form-row mt-2">
          <div class="col-md-6">
            <select class="form-control toggle-target" name="has_emited_visa" id="has_emited_visa" data-rules='[{"target":"hev","value":"Sí"}]'>
              <option value="">¿Alguna vez se le ha emitido una visa canadiense?</option>
              <option>Sí</option>
              <option>No</option>
            </select>
          </div>
        ...
        <div class="form-row mt-2 hev d-none">
          <div class="col-md-8">
            <select class="form-control toggle-target" name="visa_lost" id="has_emited_visa" data-rules='[{"target":"vl","value":"Sí"}]'>
              <option value="">¿Su visa canadiense se le ha perdido o ha sido robada?</option>
              <option>Sí</option>
              <option>No</option>
            </select>
          </div>
        ...
        <div class="form-row mt-2 hev d-none">
          <div class="col-md-12">
            <select class="form-control toggle-target" name="visa_revoked" id="visa_revoked" data-rules='[{"target":"vr","value":"Sí"}]'>
              <option value="">¿Su visa canadiense ha sido cancelada o revocada?</option>
              <option>Sí</option>
              <option>No</option>
            </select>
          </div>
        ...
        <div class="form-row mt-2">
          <div class="col-md-12">
            <select class="form-control toggle-target" name="visa_denied" id="visa_denied" data-rules='[{"target":"vd","value":"Sí"}]'>
              <option value="">¿Alguna vez le han negado la visa canadiense, le han negado la admisión a Canadá o le han retirado su solicitud de admisión en el puerto de entrada?</option>
              <option>Sí</option>
              <option>No</option>
            </select>
          </div>
        ...
        <div class="form-row mt-2">
          <div class="col-md-12">
            <select class="form-control toggle-target" name="immigrant_petition" id="immigrant_petition" data-rules='[{"target":"ip","value":"Sí"}]'>
              <option value="">¿Alguien ha presentado alguna vez una petición de inmigrante en su nombre ante los Servicios de Inmigración y Ciudadanía de Canadá?</option>
              <option>Sí</option>
              <option>No</option>
            </select>
          </div>
    ...
    <!-- 7. INFORMACIÓN DE CONTACTO EN LOS Canadá -->
    <div class="border p-4">
        <h5>7. Información de contacto en los Canadá</h5>
        ...
        <div class="form-row mt-2">
            <div class="col-md-12">
                <input type="text" class="form-control" name="us_contact_address" placeholder="Dirección completa en los Canadá">
            </div>
        </div>
    ...
    <div class="border p-4">
        ...
        <div class="form-row mt-2">
            ...
            <div class="col-md-6">
                <input type="date" class="form-control" name="father_birthday" placeholder="Fecha de nacimiento">
                <small>Fecha de nacimiento</small>
            </div>
        </div>
        <div class="form-row mt-2">
            <div class="col-md-6">
                <select class="form-control toggle-target" name="father_in_usa" data-rules='[{"target":"father_status","value":"Sí"},{"target":"father_dieday","value":"No"}]'>
                    <option value="">¿Se encuentra aun vivo?</option>
                    <option>Sí</option>
                    <option>No</option>
                </select>
            </div>
            <div class="col-md-6 d-none father_status ">
                <input type="text" class="form-control" name="where_father_live" placeholder="Donde se encuentra viviendo">
            </div>
            <div class="col-md-6 mother_dieday d-none">
                <input type="date" class="form-control" name="father_dieday" placeholder="Fecha de fallecimiento">
        ...
        <div class="form-row mt-2">
            <div class="col-md-6">
                <select class="form-control toggle-target" name="mother_in_usa" data-rules='[{"target":"mother_status","value":"Sí"},{"target":"mother_dieday","value":"No"}]'>
                    <option value="">¿Se encuentra aun viva?</option>
                    <option>Sí</option>
                    <option>No</option>
                </select>
            </div>
            <div class="col-md-6 d-none mother_status ">
                <input type="text" class="form-control" name="where_mother_live" placeholder="Donde se encuentra viviendo">
            </div>
            <div class="col-md-6 mother_dieday d-none">
                <input type="date" class="form-control" name="mother_dieday" placeholder="Fecha de fallecimiento">
                <small>Fecha de fallecimiento</small>
            </div>
        </div>
        ...
        <div class="form-row mt-3">
            <div class="col-md-12">
                <select class="form-control toggle-target" name="immediate_relatives_usa" data-rules='[{"target":"immediate_relatives_fields","value":"Sí"}]'>
                    <option value="">¿Tiene parientes inmediatos en los Canadá?</option>
                    <option>Sí</option>
                    <option>No</option>
                </select>
            </div>
        ...
        <p class=" mt-2"><b>4. Hijos</b></p>
        <!-- 5. Cónyuge / Unión libre / Unión civil -->
        <div class="form-row mt-3">
            <div class="col-md-12">
                <select class="form-control toggle-target" name="child" id="child"
                        data-rules='[{"target":"have_child","value":"Sí"}]'>
        ...
        <div class="col-md-12 have_child">
            <div class="form-row mt-3 ">
                <div class="col-md-6">
                    <input type="text" class="form-control" name="child1" placeholder="Nombres completos">
                </div>
                <div class="col-md-3">
                    <input type="date" class="form-control" name="childbirthday1" placeholder="Fecha de nacimiento">
                </div>
                <div class="col-md-3">
                    <input type="text" class="form-control" name="childresident1" placeholder="residencia">
                </div>
            </div>
            <div class="form-row mt-3 ">
                <div class="col-md-6">
                    <input type="text" class="form-control" name="child2" placeholder="Nombres completos">
                </div>
                <div class="col-md-3">
                    <input type="date" class="form-control" name="childbirthday2" placeholder="Fecha de nacimiento">
                </div>
                <div class="col-md-3">
                    <input type="text" class="form-control" name="childresident2" placeholder="residencia">
                </div>
            </div>
            <div class="form-row mt-3 ">
                <div class="col-md-6">
                    <input type="text" class="form-control" name="child3" placeholder="Nombres completos">
                </div>
                <div class="col-md-3">
                    <input type="date" class="form-control" name="childbirthday3" placeholder="Fecha de nacimiento">
                </div>
                <div class="col-md-3">
                    <input type="text" class="form-control" name="childresident3" placeholder="residencia">
                </div>
            </div>
            <div class="form-row mt-3 ">
                <div class="col-md-6">
                    <input type="text" class="form-control" name="child4" placeholder="Nombres completos">
                </div>
                <div class="col-md-3">
                    <input type="date" class="form-control" name="childbirthday4" placeholder="Fecha de nacimiento">
                </div>
                <div class="col-md-3">
                    <input type="text" class="form-control" name="childresident4" placeholder="residencia">
                </div>
            </div>
        </div>
        
        
        <p class=" mt-2"><b>5. Divorciado/a</b></p>
        <!-- 4. Divorciado/a -->
        <div class="form-row mt-3">
            <div class="col-md-8">
        ...
        <p class=" mt-2"><b>6. Cónyuge / Unión libre / Unión civil</b></p>
        <!-- 5. Cónyuge / Unión libre / Unión civil -->
        <div class="form-row mt-3">
            <div class="col-md-12">
        ...
        <p class=" mt-2"><b>8. Otros familiares</b></p>
        <!-- 7. Otros familiares -->
        <div class="form-row mt-3">
            <div class="col-md-12">
        ...
        <div class="form-row mt-3">
            <div class="col-md-12">
                <select class="form-control toggle-target" name="studied_high_school_or_higher" data-rules='[{"target":"education_fields","value":"Sí"}]'>
                    <option value="">¿Ha estudiado curso, bachillerato o master?</option>
                    <option>Sí</option>
                    <option>No</option>
                </select>
            </div>
        </div>
        <div class="col-md-12 mt-2 education_fields">
            <div class="form-row mt2 ">
                <div class="col-md-12">
                    <input type="text" class="form-control" name="education_course1" placeholder="Especificar curso de estudio / especialidad">
                </div>
                <div class="col-md-3">
                    <input type="date" class="form-control" name="education_datestart1" placeholder="Fecha de inicio">
                    <small>Fecha de inicio</small>
                </div>
                <div class="col-md-3">
                    <input type="date" class="form-control" name="education_datend1" placeholder="Fecha de finalización">
                    <small>Fecha de finalización</small>
                </div>
                <div class="col-md-6">
                    <input type="text" class="form-control" name="education_institution1" placeholder="Nombre de la institución">
                </div>
            </div>
            <div class="form-row mt2 ">
                <div class="col-md-12">
                    <input type="text" class="form-control" name="education_course2" placeholder="Especificar curso de estudio / especialidad">
                </div>
                <div class="col-md-3">
                    <input type="date" class="form-control" name="education_datestart2" placeholder="Fecha de inicio">
                    <small>Fecha de inicio</small>
                </div>
                <div class="col-md-3">
                    <input type="date" class="form-control" name="education_datend2" placeholder="Fecha de finalización">
                    <small>Fecha de finalización</small>
                </div>
                <div class="col-md-6">
                    <input type="text" class="form-control" name="education_institution2" placeholder="Nombre de la institución">
                </div>
            </div>
            <div class="form-row mt2 ">
                <div class="col-md-12">
                    <input type="text" class="form-control" name="education_course3" placeholder="Especificar curso de estudio / especialidad">
                </div>
                <div class="col-md-3">
                    <input type="date" class="form-control" name="education_datestart3" placeholder="Fecha de inicio">
                    <small>Fecha de inicio</small>
                </div>
                <div class="col-md-3">
                    <input type="date" class="form-control" name="education_datend3" placeholder="Fecha de finalización">
                    <small>Fecha de finalización</small>
                </div>
                <div class="col-md-6">
                    <input type="text" class="form-control" name="education_institution3" placeholder="Nombre de la institución">
                </div>
            </div>
            <div class="form-row mt2 ">
                <div class="col-md-12">
                    <input type="text" class="form-control" name="education_course4" placeholder="Especificar curso de estudio / especialidad">
                </div>
                <div class="col-md-3">
                    <input type="date" class="form-control" name="education_datestart4" placeholder="Fecha de inicio">
                    <small>Fecha de inicio</small>
                </div>
                <div class="col-md-3">
                    <input type="date" class="form-control" name="education_datend4" placeholder="Fecha de finalización">
                    <small>Fecha de finalización</small>
                </div>
                <div class="col-md-6">
                    <input type="text" class="form-control" name="education_institution4" placeholder="Nombre de la institución">
                </div>
            </div>
